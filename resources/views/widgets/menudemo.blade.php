...
<header id="header">  
    <div class="container-fluid">      
     <div id="" class="pull-left imgtop">
        <a href="/" class="scrollto"> <img src="{{url('/')}}/img/cyclingburmar.png" style=" height: 60px;" alt="imglogo"></a>     
      </div>
...
<div id="logo" class="pull-left" style="position: absolute; width: 100%; z-index: 1;">
    <h1>
      <a href="{{url('/')}}" title="{{config('app.title')}}">
        <img class="mylogo" src="{{url('/')}}/img/cyclingburmar.png" alt="imglogo" >
      </a>
    </h1>
</div>
