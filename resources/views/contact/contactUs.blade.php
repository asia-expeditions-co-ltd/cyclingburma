...
<div class="title-section">
    <div class="container"><br>
        <div class="row">         
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" id="eshow" name="email" class="form-control" placeholder="example@gmail.com" required="required" />
                                        </div>
                                    </div>  
            ...
            <div class="col-md-6">  
                <div class="example" style="margin-top: 0; height: 536px;">
                    <center>
                         
                    <img src="/photos/share/1528731595-mountain-biking-in-chi-phat.jpg" style=" border-radius: 3px;  width: 100%;">
                      </center>
                    <p style="margin-top: 40px; font-family: 'Open Sans',Arial,sans-serif !important; "> <b>A special note</b><br>
We would love to hear from you but please remember we don't have an army of desk-bound phone jockeys. While we have staff in the office weekdays, during weekends we keep an eye on emails and calls, but most of us take time out to go for a ride or relax.</p>
